package bitcamp.myapp.dao.stup;
...
public class ProjectDaoStup implements ProjectDao {
  ...
  public ProjectDaoStup(ObjectInputStream in, ObjectOutputStream out, String dataName)
      throws Exception {
    this.in = in;
    this.out = out;
