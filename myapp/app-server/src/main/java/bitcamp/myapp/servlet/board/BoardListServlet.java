...
public class BoardListServlet implements Servlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<thead>");
            out.println("<tr>");
            out.println("<th>번호</th><th>제목</th><th>작성자</th><th>작성일</th><th>조회수</th>");
            out.println("</tr>");
            out.println("</thead>");
            out.println("<tbody>");
            out.println("<h1>게시판 목록</h1>");
            for (Board board : boardDao.list()) {
                out.printf("<tr><td>%d</td><td>%s</td><td><a href='/board/view?no=%1$d'>%s</a></td><td>%tY-%4$tm-%4$td</td><td>%d</td></tr>\n",
